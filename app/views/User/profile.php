        ...
        <div class="profile user-profile">
            ...
            <div class="profiles_banner">
                ...
                <div class="profile_action absolute bottom-0 right-0 space-x-1.5 p-3 text-sm z-50 hidden lg:flex">
                  ...
                  <a href="user/edit-profile" class="flex items-center justify-center h-8 px-3 rounded-md bg-gray-700 bg-opacity-70 text-white space-x-1.5">
            ...
            <div class="profiles_content">
                ...
                <div class="profile_avatar">
                    <div class="profile_avatar_holder">
                        <?=\app\helpers\User::getImgCode($id);?>
                    </div>
                ...
                <div class="profile_info">
                    <h1> <?=\app\helpers\User::getUserFullName($id);?> </h1>
                    <p> Gamer <a href="user/edit-hobbies">Edit </a></p>
                </div>
                        ...
                        <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                           ...
                           <div class="flex justify-between items-center lg:p-4 p-2.5">
                               <div class="flex flex-1 items-center space-x-4">
                                   <a href="#">
                                       <?=\app\helpers\User::getImgCode($post->user_id);?>
                                   </a>
                                   <div class="flex-1 font-semibold capitalize">
                                       <a href="#" class="text-black dark:text-gray-100"> <?=\app\helpers\User::getUserFullName($post->user_id);?> </a>
                             ...
                             <div>
                               ...
                               uk-drop="mode: click;pos: bottom-right;animation: uk-animation-slide-bottom-small">
                                   ...
                                   <ul class="space-y-1">
                                     ...
                                     <li>
                                         <a href="posts/disable-comments?id=<?=$post->id;?>" class="flex items-center px-3 py-2 hover:bg-gray-200 hover:text-gray-800 rounded-md dark:hover:bg-gray-800">
                                          <i class="uil-comment-slash mr-1"></i>   Disable comments
                                         </a>
                                     </li>
                                     <li>
                                         <a href="posts/add-favorite?id=<?=$post->id;?>" class="flex items-center px-3 py-2 hover:bg-gray-200 hover:text-gray-800 rounded-md dark:hover:bg-gray-800">
                           ...
                           <div uk-lightbox>
                               ...
                               <?=\app\helpers\Post::getPostImages($post->id, 'max-h-96 w-full object-cover');?>

                               <?php if(strpos($post->img, '|')): ?>
                                   <?php $files = explode('|', $post->img); ?>
                                   <?php foreach ($files as $file): ?>
                                   <?php if(is_file($file)): ?>
                                   <a href="<?=$file;?>">
                                       <img src="<?=$file;?>" alt="" class="max-h-96 w-full object-cover">
                                   </a>
                                   <?php endif; ?>
                                   <?php endforeach; ?>
                               <?php endif; ?>
